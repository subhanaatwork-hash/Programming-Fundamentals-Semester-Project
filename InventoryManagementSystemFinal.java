...
static void salesLogin() {
    ...
    static void addVendor() {
        if (vendorCount >= MAX_VENDORS) { System.out.println("Cannot add more vendors."); return; }
        System.out.print("Enter Vendor Name: "); String name = sc.nextLine();
        System.out.print("Enter Vendor Contact: "); String contact = sc.nextLine();
        vendorNames[vendorCount] = name; vendorContacts[vendorCount] = contact; vendorCount++;
        saveVendorsToFile();
    ...
    static void viewVendors() {
        System.out.println("\n--- VENDORS ---");
        if (vendorCount == 0) { System.out.println("No vendors available."); return; }
    ...
    static void deleteVendor() {
        viewVendors();
        System.out.print("Enter vendor number to delete: "); String s = sc.nextLine();
        int idx = stringToIndex(s, vendorCount); if (idx==-1) return;
